    ...
    def _build_quick_actions(self) -> QWidget:
        ...
        categories = [
            ...
            ("📋  Logy", [
                ...
                ("Chyby (errors)", "Ukáž len ERROR a CRITICAL záznamy z logov"),
            ...
            ("🌐  Sieťové nástroje", [
                ...
                ("Bandwidth",      "Ukáž aktuálnu sieťovú rýchlosť (nload/ifstat)"),
            ]),
            ("📁  Git", [
            ...
            ("📦  Balíčky (pacman)", [
                ("Aktualizácie",   "Skontroluj dostupné aktualizácie systému (checkupdates)"),
            ...
            ("☁️  Cloud & CI/CD", [
                ...
                ("GitHub Actions", "Ukáž stav posledných GitHub Actions bezhov (gh run list)"),
                ("Docker Hub",     "Ukáž lokálne Docker images a ich veľkosť"),
                ("Terraform",      "Ukáž stav Terraform workspace (terraform show)"),
            ]),
            ("💾  Zálohy & Súbory", [
                ("Veľké súbory",   "Nájdi 10 najväčších súborov v /home a /var"),
                ("Disk usage",     "Ukáž využitie disku po adresároch (du -sh /*)"),
                ("Tmp súbory",     "Nájdi staré dočasné súbory v /tmp starší ako 7 dní"),
                ("Rsync status",   "Ukáž posledné rsync zálohovacie logy"),
            ]),
            ("🤖  AI & Modely", [
                ("Ollama modely",  "Vypíš lokálne nainštalované Ollama modely a veľkosť"),
                ("GPU info",       "Ukáž využitie GPU, VRAM a teplotu"),
                ("AIOS status",    "Ukáž stav AIOS daemona, AI router a hlasový modul"),
                ("Agenti",         "Aké AIOS agenty sú dostupné a čo vedia robiť?"),
            ]),
        ]
